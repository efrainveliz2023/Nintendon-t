...
/******************************************************************************
 *  Compilation:  javac main.java.com.Nintendont.DK.Source.Floor.java
 *  Execution:    java main.java.com.Nintendont.DK.Source.Floor (runs basic testing)
 *  Dependencies: image files
 *
 *  Creates a floor object for Donkey Kong Game. main.java.com.Nintendont.DK.Source.Floor can be drawn and
...
public class Floor {
    ...
    public static void main(String[] args) {
        ...
        /*implementing with main.java.com.Nintendont.DK.Source.LinkedList*****************************************
        main.java.com.Nintendont.DK.Source.LinkedList<main.java.com.Nintendont.DK.Source.Floor> floors = new main.java.com.Nintendont.DK.Source.LinkedList<main.java.com.Nintendont.DK.Source.Floor>();
        
        for (int i = 0; i < 6; i++) { //add 6 floora
           if (i % 2 == 0) {
                floors.add(new main.java.com.Nintendont.DK.Source.Floor(0.4, 0.8 - i * 0.15));
            }
            else {
                floors.add(new main.java.com.Nintendont.DK.Source.Floor(0.6, 0.65 - (i - 1) * 0.15));
            }
        }
