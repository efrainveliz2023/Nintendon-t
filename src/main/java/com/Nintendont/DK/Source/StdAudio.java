 ...
 *  Compilation:  javac Resources.StdAudio.java
 *  Execution:    java Resources.StdAudio
 *  Dependencies: none
 *
...
public final class StdAudio {
    ...
    public static synchronized void play(final String filename) {
        ...
        try {
            ...
            URL is = StdAudio.class.getClassLoader().getResource(filename);
    ...
    private static void playApplet(String filename) {
        ...
        // URL url = Resources.StdAudio.class.getResource(filename);
        if (url == null) {
