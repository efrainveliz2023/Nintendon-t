...
This code is relatively EFFICIENT. It uses a linkedlist to get rid of unused
    ...
    loop to make more efficient. In addition, because main.Resources.PennDraw.enableAnimation()
...
when you run the program, assuming you have the latest version of Java installed.
    ...
    a special tune that plays for losing. Because main.Resources.StdAudio.java does not have a
