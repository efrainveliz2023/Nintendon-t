...
/******************************************************************************
 *  Compilation:  javac main.Source.Floor.java
 *  Execution:    java main.Source.Floor (runs basic testing)
 *  Dependencies: image files
 *
 *  Creates a floor object for Donkey Kong Game. main.Source.Floor can be drawn and
...
public class Floor {
    ...
    public static void main(String[] args) {
        ...
        /*implementing with main.Source.LinkedList*****************************************
        main.Source.LinkedList<main.Source.Floor> floors = new main.Source.LinkedList<main.Source.Floor>();
        
        for (int i = 0; i < 6; i++) { //add 6 floora
           if (i % 2 == 0) {
                floors.add(new main.Source.Floor(0.4, 0.8 - i * 0.15));
            }
            else {
                floors.add(new main.Source.Floor(0.6, 0.65 - (i - 1) * 0.15));
            }
        }
