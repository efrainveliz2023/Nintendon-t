...
/******************************************************************************
 *  Compilation:  javac main.Source.Peach.java
 *  Execution:    java main.Source.Peach (runs basic testing
 *  Dependencies: image files
 *
 *  Creates a main.Source.Peach object for Donkey Kong Game. main.Source.Peach can
