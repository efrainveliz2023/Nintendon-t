...
/******************************************************************************
 *  Compilation:  javac main.Source.Ladder.java
 *  Execution:    java main.Source.Ladder (runs basic testing)
 *  Dependencies: image files
 *
 *  Creates a main.Source.Ladder object for Donkey Kong Game. main.Source.Ladder can
