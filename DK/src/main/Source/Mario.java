...
import main.Resources.StdAudio;

/******************************************************************************
 *  Compilation:  javac main.Source.Mario.java
 *  Execution:    java main.Source.Mario (runs basic testing
 *  Dependencies: image files
 *
 *  Creates a main.Source.Mario object for Donkey Kong Game. main.Source.Mario can
 * move, fall, and stop depending on floors inputted. main.Source.Mario can be checked
...
public class Mario {
    ...
    /* Constructor: sets main.Source.Mario's x and y location */
