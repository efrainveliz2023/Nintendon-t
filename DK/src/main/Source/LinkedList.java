 ...
 *
 * Execution: java main.Source.LinkedList
 *
 * This program creates a generic main.Source.LinkedList class and implements the generic
 * main.Source.List.java interface. It contains a private Node class which is used to
 * connect points within the main.Source.LinkedList.
 *
 */
public class LinkedList<T> implements List<T> {
     ...
     *
     * @param element element whose presence in this main.Source.List is to be tested.
