...
/******************************************************************************
 *  Compilation:  javac main.Source.Barrel.java
 *  Execution:    java main.Source.Barrel (runs basic testing)
 *  Dependencies: image files
 *
 *  Creates a barrel object for Donkey Kong Game. main.Source.Barrel can
