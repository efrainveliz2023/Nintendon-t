...
The OBJECTS included in this program include a barrel, a Source.DonkeyKong, floors,
    ...
    Source.DonkeyKong is the only object that does not interact with any other object.
    Most interactions are handled through the mario object. Source.Mario checks
    if his location is the same as the ladders, barrels, and peach. The floors
    check if Source.Mario is colliding with them. The floors also check if they are
    colliding
    ...
    object
    or as a part of the Source.Mario object. We decided to have it as part of the mario
    ...
    CLASSES/OBJECTS are broken down into necessary functions for that object.
        Source.Mario can be drawn, be drawn as pikachu, check for collisions, fall,
        ...
        Source.Peach, Source.Ladder, and Source.DonkeyKong only have draw functions and getter functions
        for their location. Their constructors set their x, y locations.
        
        The Source.Barrel includes a falling function (which changes its floorlevel
                                                    variable), a stopping falling
        function, and various move functions. 
        
        The Source.Floor includes draw and get functions and collision functions.
...
The TECHNIQUES included are checking for collisions between various objects:
    ...
    Source.Mario is able to be drawn as Pikachu or Source.Mario depending on his y Location.
...
This code is relatively EFFICIENT. It uses a linkedlist to get rid of unused
    ...
    loop to make more efficient. In addition, because Resources.PennDraw.enableAnimation()
...
when you run the program, assuming you have the latest version of Java installed.
    The instructions included are: Press 'a' to move Source.Mario character left,
    'd' to move right, 'w' to jump or climb ladders, and 's' to move down
    ladders. Once Source.Mario character reaches the third floor Level, he will turn
    ...
    The goal of the game is to climb all the ladders to get to Princess Source.Peach
    ...
    nothing happens when he collides with Source.DonkeyKong or the barrels to the left
    of donkey Kong.
    ...
    a special tune that plays for losing. Because Resources.StdAudio.java does not have a
...
/**********************************************************************
 *  How precisely did your project use the Source.LinkedList you implemented?
 **********************************************************************/
...
/**********************************************************************
 *  Source.List whatever help (if any) that you received
 **********************************************************************/
